	...
	<div class="container">
		<div class="album py-5">
			<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<!-- 修改表單 -->
											<form:form class="form" method="post" modelAttribute="newPet"
												action="${contextRoot}/timmy/editPet"
												enctype="multipart/form-data">
												<form:input path="petId" type="hidden"
													value="${p.petId}" />
												<!--頭像上傳-->
												<div class="container">
												...
												<div class="form-group" style="text-align: left;">
													...
													<form:input path="petName" type="text"
														class="form-control" value="${p.petName}" />
												</div>
												<!--生日-->
												<div class="form-group" style="text-align: left;">
				...
				<div class="col">
					<div class="card">
						<a class="btn btn-outline-secondary icon" role="button"
