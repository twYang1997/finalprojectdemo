  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link" href="${contextRoot}/uploadPage2">檔案上傳（路徑方式）</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="${contextRoot}/listPhoto">列出所有圖片</a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="${contextRoot}/listPhoto2">列出所有圖片（路徑方式）</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="${contextRoot}/addMember">測試會員</a>
      </li>
