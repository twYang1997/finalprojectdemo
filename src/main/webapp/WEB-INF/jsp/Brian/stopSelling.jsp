...
<%-- 							<c:if test="${Products.productStatus==1}"> --%>
								<tr><td>123</td>
<%-- 									<td class="col-md-3">${users.postUser.email}</td> --%>
									<td class="col-md-6"><c:forEach items="${Products}" var="Products"
											varStatus="vs">
											<c:if test="${Products.getproductStatus()==1}">
												<a href="#">${Products.productName}</a>
<%-- 												<span><i class="fa fa-clock">${Products.productDate}</i> </span> --%>
												<!-- post內文 -->
												<div id="box">
													${Products.productContext}
													<!-- post圖片 -->
<%-- 													<c:forEach items="${Products}" var="pImg" --%>
<%-- 														varStatus="loop"> --%>
<!-- 														<ul class="gallery" style="list-style: none;"> -->
<!-- 															<li><img -->
<%-- 																src="${contextRoot}/${pImg.productImg}"></li> --%>
<!-- 														</ul> -->
<%-- 													</c:forEach> --%>
												</div>
...
<%-- 										href="${contextRoot}/stopProducts?id=${Products.productId}" --%>
<!-- 										role="button">移除</a></td> -->
