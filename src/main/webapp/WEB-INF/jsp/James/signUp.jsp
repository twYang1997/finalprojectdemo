							...
							<div class="row justify-content-center">
								<div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
									...
									<form:form class="form" method="post" modelAttribute="users"
										action="${contextRoot}/timmy/signUp.controller">
										...
										<div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
											<button type="submit" class="btn btn-primary btn-lg" onclick="sss()">Register</button>
										</div>
										<script>
...
function sss(){
	 swal("Registration complete", "success",{button: "Login" }).then(function (){ window.location = "${contextRoot}/timmy/";});
 }
// swal({
//     icon: "info",
//     buttons: {
